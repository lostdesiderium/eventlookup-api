...
namespace EventLookup.Migrations
{
    ...
    [Migration("20200329103147_UserEventMtM")]
    partial class UserEventMtM
    {
            ...
            modelBuilder.Entity("EventLookup.Domain.Models.Event", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            EventId = 1,
                            DaysEventActive = 3,
                            FinishDate = new DateTime(2020, 4, 29, 13, 31, 46, 731, DateTimeKind.Local).AddTicks(6057),
                            ...
                            StartDate = new DateTime(2020, 3, 29, 13, 31, 46, 728, DateTimeKind.Local).AddTicks(6833),
                        ...
                        new
                        {
                            EventId = 2,
                            DaysEventActive = 3,
                            FinishDate = new DateTime(2020, 4, 29, 13, 31, 46, 731, DateTimeKind.Local).AddTicks(7237),
                            ...
                            StartDate = new DateTime(2020, 3, 31, 13, 31, 46, 731, DateTimeKind.Local).AddTicks(7187),
                        ...
                        new
                        {
                            EventId = 3,
                            DaysEventActive = 3,
                            FinishDate = new DateTime(2020, 5, 7, 13, 31, 46, 731, DateTimeKind.Local).AddTicks(7277),
                            ...
                            StartDate = new DateTime(2020, 5, 4, 13, 31, 46, 731, DateTimeKind.Local).AddTicks(7273),
                        ...
                        new
                        {
                            EventId = 4,
                            DaysEventActive = 4,
                            FinishDate = new DateTime(2020, 4, 10, 13, 31, 46, 731, DateTimeKind.Local).AddTicks(7284),
                            ...
                            StartDate = new DateTime(2020, 4, 6, 13, 31, 46, 731, DateTimeKind.Local).AddTicks(7281),
                        ...
                        new
                        {
                            EventId = 5,
                            DaysEventActive = 3,
                            FinishDate = new DateTime(2020, 5, 3, 13, 31, 46, 731, DateTimeKind.Local).AddTicks(7291),
                            ...
                            StartDate = new DateTime(2020, 4, 30, 13, 31, 46, 731, DateTimeKind.Local).AddTicks(7288),
