...
namespace EventLookup.Migrations
{
    ...
    [Migration("20200329095947_UserAndIdsFix")]
    partial class UserAndIdsFix
    {
            ...
            modelBuilder.Entity("EventLookup.Domain.Models.Event", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            EventId = 1,
                            DaysEventActive = 3,
                            FinishDate = new DateTime(2020, 4, 29, 12, 59, 47, 222, DateTimeKind.Local).AddTicks(7663),
                            ...
                            StartDate = new DateTime(2020, 3, 29, 12, 59, 47, 219, DateTimeKind.Local).AddTicks(4855),
                        ...
                        new
                        {
                            EventId = 2,
                            DaysEventActive = 3,
                            FinishDate = new DateTime(2020, 4, 29, 12, 59, 47, 222, DateTimeKind.Local).AddTicks(9770),
                            ...
                            StartDate = new DateTime(2020, 3, 31, 12, 59, 47, 222, DateTimeKind.Local).AddTicks(9720),
                        ...
                        new
                        {
                            EventId = 3,
                            DaysEventActive = 3,
                            FinishDate = new DateTime(2020, 5, 7, 12, 59, 47, 222, DateTimeKind.Local).AddTicks(9804),
                            ...
                            StartDate = new DateTime(2020, 5, 4, 12, 59, 47, 222, DateTimeKind.Local).AddTicks(9800),
                        ...
                        new
                        {
                            EventId = 4,
                            DaysEventActive = 4,
                            FinishDate = new DateTime(2020, 4, 10, 12, 59, 47, 222, DateTimeKind.Local).AddTicks(9811),
                            ...
                            StartDate = new DateTime(2020, 4, 6, 12, 59, 47, 222, DateTimeKind.Local).AddTicks(9808),
                        ...
                        new
                        {
                            EventId = 5,
                            DaysEventActive = 3,
                            FinishDate = new DateTime(2020, 5, 3, 12, 59, 47, 222, DateTimeKind.Local).AddTicks(9819),
                            ...
                            StartDate = new DateTime(2020, 4, 30, 12, 59, 47, 222, DateTimeKind.Local).AddTicks(9816),
